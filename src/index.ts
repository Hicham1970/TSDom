...
function myFunction() {
  ...
  let monTexte = document.createTextNode(
    "Je na sais pas ce que je fait maintenant , mais j'adores  faire des tests ..., Oui je vois : Je suis en train de dire au javascript de me créer un autre paragraphe qui mentionne toutes ces sottises, et a qui va s'ajouter le text qui va venir apres ces pointillés........ "
  );
